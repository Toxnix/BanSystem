...
public class ClearBans implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String s, @NotNull String[] args) {
        ...
        if (args.length != 1) {
            sender.sendMessage(config.get("bansystem.clearbans.syntax", true));
            return false;
        }
        ...
        UUIDFetcher.getUUID(playerName, uuid -> {
            ...
            String unbannedBy = (sender instanceof Player) ? sender.getName() : config.get("bansystem.consolename");
            ...
            Util.broadcastMessage(config.get("bansystem.clearbans.successful")
                    ...
                    "bansystem.clearbans", ServerSoftware.SPIGOT);
        });
        return false;
    }
}